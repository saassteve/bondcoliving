/*
  # Fix RLS Performance and Security Issues (Final)
...
-- =====================================================
-- 6. Set search_path on SECURITY DEFINER functions
-- =====================================================
...
-- iCal sync functions (with correct signatures)
ALTER FUNCTION compute_blocked_days_for_feed(uuid) SET search_path = public, pg_temp;
ALTER FUNCTION compute_blocked_days_for_feed(uuid, text, text) SET search_path = public, pg_temp;
ALTER FUNCTION sync_availability_from_ical(uuid, text) SET search_path = public, pg_temp;
ALTER FUNCTION sync_availability_from_ical(uuid, text, text) SET search_path = public, pg_temp;