/*
  # Fix Coworking Admin Visibility - Final Fix

  ## Problem
  Admins cannot see coworking bookings or pass types in the admin panel.
  The is_admin() function has incorrect search_path configuration.

  ## Solution
  1. Recreate is_admin() with explicit SET search_path = public
  2. Recreate is_super_admin() with same pattern
  3. Recreate all RLS policies that were dropped with CASCADE
  4. Fix coworking-specific policies
...
-- =====================================================
-- PART 2: Fix is_super_admin() Function
-- =====================================================
...
DROP POLICY IF EXISTS "Authenticated can view active passes" ON coworking_passes;
...
-- =====================================================
-- PART 5: COWORKING_PASS_AVAILABILITY_SCHEDULES
-- =====================================================
...
-- =====================================================
-- PART 9: Recreate policies on other tables (CASCADE dropped them)
-- =====================================================
...
-- =====================================================
-- PART 10: ADMIN_USERS (special handling)
-- =====================================================
...
-- =====================================================
-- PART 11: Sync admin_users.user_id with auth.users
-- =====================================================
...
AND (admin_users.user_id IS NULL OR admin_users.user_id != au.id);
