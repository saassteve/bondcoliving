...
const Hero: React.FC = () => {
  return (
    <section className="relative h-screen flex items-center pb-48 md:pb-40 lg:pb-24">
      <div className="absolute inset-0 bg-black/60 z-10"></div>
      <div className="absolute inset-0 bg-[url('https://iili.io/FcOqdX9.png')] bg-cover bg-[center_bottom_20%]"></div>
      <div className="container relative z-20">
        <div className="max-w-3xl mb-4 md:mb-6 lg:mb-4">
          ...
          <AnimatedSection animation="fadeInUp" delay={600}>
            <p className="text-lg md:text-xl lg:text-2xl text-[#C5C5B5] mb-8 md:mb-10 lg:mb-12 leading-relaxed">
