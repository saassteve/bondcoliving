          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">{booking.guest_count} guest{booking.guest_count > 1 ? 's' : ''}</p>
              </div>
            ...
            {booking.door_code && (
              <div>
                ...
                <p className="font-mono text-lg bg-gray-100 px-3 py-2 rounded-lg inline-block">{booking.door_code}</p>
              </div>
            )}
