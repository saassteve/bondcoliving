      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleAddFeature} className="mb-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent min-w-[120px]"
            >
        ...
        {features.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-gray-600">Add features like air conditioning, ocean views, or premium amenities.</p>
          </div>
        ) : (
          <div className="space-y-2">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.id}
                  className="flex items-center justify-between p-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 group"
                >
