      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-6">
          ...
          <div className="bg-gray-800 rounded-lg shadow-sm p-3 sm:p-4 border border-gray-600">
            ...
            <div className="text-xs sm:text-sm text-gray-300 font-semibold">Confirmed</div>
          </div>
          <div className="bg-gray-800 rounded-lg shadow-sm p-3 sm:p-4 border border-gray-600">
            <div className="text-xl sm:text-2xl font-bold text-green-400">{stats.checkedIn}</div>
            <div className="text-xs sm:text-sm text-gray-300 font-semibold">Checked In</div>
          </div>
          <div className="bg-gray-800 rounded-lg shadow-sm p-3 sm:p-4 border border-gray-600">
