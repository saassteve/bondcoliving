    ...
    <div className="min-h-screen bg-[#1E1F1E]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 lg:pb-8">
        <div className="mb-8">
          ...
          <p className="text-[#C5C5B5]/80">Request maintenance, cleaning, or other services</p>
        </div>

        <div className="bg-[#C5C5B5]/5 border border-[#C5C5B5]/20 rounded-2xl p-12 text-center backdrop-blur-sm">
          <Wrench className="h-16 w-16 text-[#C5C5B5]/40 mx-auto mb-4" />
          <h3 className="text-lg font-semibold text-white mb-2">Service Requests Coming Soon</h3>
