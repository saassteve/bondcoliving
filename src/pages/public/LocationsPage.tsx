...
import { ArrowLeft, ArrowRight, Building2, MapPin, Wifi } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore Bond's three coliving locations in central Funchal, Madeira. Premium apartments for digital nomads."
        />
      </Helmet>
